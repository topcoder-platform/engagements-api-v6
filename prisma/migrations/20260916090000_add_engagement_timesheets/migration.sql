...
-- CreateTable
CREATE TABLE "EngagementTimesheetEntryAudit" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "EngagementTimesheetEntryAudit_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "EngagementTimesheetEntryAudit_timesheetEntryId_createdAt_idx" ON "EngagementTimesheetEntryAudit"("timesheetEntryId", "createdAt");

-- CreateIndex
CREATE INDEX "EngagementTimesheetEntryAudit_actorUserId_idx" ON "EngagementTimesheetEntryAudit"("actorUserId");
...
-- AddForeignKey
ALTER TABLE "EngagementTimesheetEntryAudit" ADD CONSTRAINT "EngagementTimesheetEntryAudit_timesheetEntryId_fkey" FOREIGN KEY ("timesheetEntryId") REFERENCES "EngagementTimesheetEntry"("id") ON DELETE CASCADE ON UPDATE CASCADE;
